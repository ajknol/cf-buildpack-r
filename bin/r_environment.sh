...
export PATH="/app/vendor/R/bin:app/vendor/Python/bin:/app/vendor/.apt/usr/bin:/app/bin:/usr/ruby1.9.2/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/bin:/usr/sbin:/sbin:$PATH"
export PYTHONUSERBASE="/app/vendor/Python"
